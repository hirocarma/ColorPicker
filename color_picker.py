...
def printColor(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN and flags & cv2.EVENT_FLAG_SHIFTKEY:
        ...
        if drawing == True:
            ...
            txt3 = "Colorcode:" + "{:x}".format(r) + "{:x}".format(g) + "{:x}".format(b)
            txt4 = "Colorname:" + color_name
            txt5 = "Coordinate:"
            txt6 = str(iy) + ":" + str(y) + "x" + str(ix) + ":" + str(x)
            ...
            cv2.rectangle(
                #pick, pt1=(200, 60), pt2=(360, 140), color=(c_b, c_g, c_r), thickness=-1
                pick, pt1=(360, 60), pt2=(480, 140), color=(c_b, c_g, c_r), thickness=-1
            )
            ...
            c_txt1 = "RGB:" + str(c_r) + "," + str(c_g) + "," + str(c_b)
            cv2.putText(
                pick,
                c_txt1,
                (340, 80),
            ...
            c_txt2 = "HSV:" + str(c_h) + "," + str(c_s) + "," + str(c_v)
            cv2.putText(
                pick,
                c_txt2,
                (340, 100),
            ...
            r_txt1 = "RGB:" + str(r_r) + "," + str(r_g) + "," + str(r_b)
            cv2.putText(
                pick,
                r_txt1,
                (340, 180),
            ...
            r_txt2 = "HSV:" + str(r_h) + "," + str(r_s) + "," + str(r_v)
            cv2.putText(
                pick,
                r_txt2,
                (340, 200),
